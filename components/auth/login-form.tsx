    ...
    <div className="w-full max-w-md space-y-6">
      ...
      <div className="flex w-full justify-center">
        <LiquidMetalButton
          ...
          height={44}
          width={448}
          className="flex w-full items-center justify-center gap-3 rounded-lg px-4 text-sm font-medium text-primary-foreground shadow-sm transition-all disabled:cursor-not-allowed disabled:opacity-50"
        >
          {!loading && (
            <svg
              width="18"

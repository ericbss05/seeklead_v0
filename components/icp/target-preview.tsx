...
export default function TargetPreview() {
    ...
    const location = data.locations[0] || "Paris, Île-de-France, France";
    const industry = data.industries[0] || "Création de sites web";
    const companyType = data.companyTypes[0] || "Entreprise";
    const companySize = data.companySizes[0] || "11-50";
        ...
        <div className="relative h-[800px] w-full overflow-hidden rounded-tl-3xl border shadow-[0_8px_40px_rgba(0,0,0,0.06),0_2px_8px_rgba(0,0,0,0.08)]">
            ...
            <div className="mt-28 px-12">
                ...
                <div className="mt-6 flex gap-4">
                    <button className="relative rounded-full bg-[#0A66C2] px-6 py-1.5 font-semibold text-white shadow-[0_10px_24px_rgba(10,102,194,0.35)] transition-transform hover:scale-[1.03] hover:bg-blue-700">
                        Se connecter
                    </button>

                    <button className="flex items-center gap-1.5 rounded-full border border-[#0A66C2]/30 bg-white px-5 py-1.5 font-semibold text-[#0A66C2] shadow-[0_10px_24px_rgba(0,0,0,0.06)] transition-transform hover:scale-[1.03] hover:bg-blue-50">
                        <svg
                            width="18"
                            height="18"
                            viewBox="0 0 24 24"
